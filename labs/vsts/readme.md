...
- **Microsoft Azure Account**: You will need a valid and active Azure account. If you do not have one, you can sign up for a [free trial ](https://azure.microsoft.com/en-us/free/)
...
- **Visual Studio 2017** or higher version - You will need Visual Studio for some of the labs. You can use your own machine with VS 2017 installed, download and use the latest [ALM VM](https://microsoft.github.io/almvm/labs/tfs/),  or spin up a VM preinstalled with VS one on [Azure](https://portal.azure.com). 
