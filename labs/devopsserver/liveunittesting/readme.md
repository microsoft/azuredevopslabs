...
1. Open the **Test Explorer** window from **Test | Windows | Test Explorer**. All of the detected tests will appear here, and you can adjust their grouping using the **Group By Traits** button. Cycle through it until the tests are grouped as **Not Run Tests**.
