...
1. In **Solution Explorer**, right-click the **AppInsightsLab** project node and select **Configure Application Insights**.
...
1. Click **Web tests**. Web tests are automated processes you can configure Application Insights to run periodically to ensure the application is running as expected.
