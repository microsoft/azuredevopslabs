...
REM 64bit
curl -o ruby231.zip -L -k https://bintray.com/artifact/download/oneclick/rubyinstaller/ruby-2.3.1-x64-mingw32.7z?direct
...
curl -L -o update.gem -k https://rubygems.org/gems/rubygems-update-2.6.8.gem
